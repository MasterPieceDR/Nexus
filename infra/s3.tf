locals {
  app_bucket_name   = "${var.project_name}-${var.environment}-${var.bucket_suffix}-app"
  media_bucket_name = "${var.project_name}-${var.environment}-${var.bucket_suffix}-media"
}
...
resource "aws_cloudfront_origin_access_control" "app" {
  ...
  description                       = "OAC para bucket de aplicacion"
