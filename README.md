# Aplicación Web Multimedia (Estilo Pinterest) 🚀

Este proyecto es una aplicación web inspirada en Pinterest, desarrollada como **Proyecto Integrador**. Permite a los usuarios registrarse, subir contenido multimedia (imágenes y videos) a la nube, explorar un feed infinito y buscar publicaciones.

El sistema fue diseñado considerando fuertemente las **Decisiones Ético-Técnicas**, incorporando mecanismos de moderación comunitaria, control de publicaciones y restricciones de privacidad desde su arquitectura central.
